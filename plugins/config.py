...
class Config(object):
    ...
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "8121525775:AAGclLi5aRcnC-wbRaafvf6eHHQpDxgszFM")
    ...
    DATABASE_URL = os.environ.get("DATABASE_URL", "mongodb+srv://UploadLinkToFileBot:UploadLinkToFile Bot@cluster0.1gybihh.mongodb.net/? retryWrites=true&w=majority")
